...
import dev.kaixinguo.codeoffthegrid.ui.workspace.ProblemExecutionResult
import dev.kaixinguo.codeoffthegrid.ui.workspace.ProblemComposerDraft
import dev.kaixinguo.codeoffthegrid.ui.workspace.ProblemTestCase
import dev.kaixinguo.codeoffthegrid.ui.workspace.ProblemTestCaseResult
import dev.kaixinguo.codeoffthegrid.ui.workspace.ProblemTestComparisonMode
import dev.kaixinguo.codeoffthegrid.ui.workspace.ProblemStarterCodeMode
...
import dev.kaixinguo.codeoffthegrid.ui.workspace.parseComposerHintsText
...
internal object ProblemPromptFormatter {
    ...
    private fun isUnrecorded(result: ProblemExecutionResult): Boolean {
        return result.cases.isEmpty() &&
            ...
            result.status != dev.kaixinguo.codeoffthegrid.ui.workspace.ExecutionStatus.Running &&
            (
